            ...
            <div className="footer-column">
              <nav className="footer-nav">
                <ul className="footer-nav-list">
                  ...
                  <li className="footer-nav-item">
                    <Link to="/docs/getting-started/local-setup-ollama" className="footer-nav-link">Getting Started</Link>
                  </li>
                  <li className="footer-nav-item">
                    <Link to="/docs/capabilities" className="footer-nav-link">Capabilities</Link>
                  </li>
                  <li className="footer-nav-item">
                    <Link to="/docs/examples" className="footer-nav-link">Examples</Link>
                  </li>
                  <li className="footer-nav-item">
                    <Link to="/docs/troubleshooting" className="footer-nav-link">Troubleshooting</Link>
                  </li>
                  <li className="footer-nav-item">
                    <Link to="/docs/contributing/contributing-guide" className="footer-nav-link">Contributing</Link>
                  </li>
                </ul>
              </nav>
            </div>
